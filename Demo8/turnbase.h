...
void player1_unit_defend(int n);
void player1_unit_attack(int n);
void player1_unit_dead(int n);
void player2_unit_stand(int n);
void player2_unit_defend(int n);
void player2_unit_attack(int n);
void player2_unit_dead(int n);



string namepokemon[6] = {"Pig", "Cat", "Ultraman", "Fish", "Bat", "Alien"};                //ชื่อ
...
void player::showPK(){
    for(int i = 1; i<3 ; i++){
        player1_unit_stand(myteam[i].skill);
        cout << "-------------------------" << endl;
...
void player::swappokemon(int n) {
    ...
    if(myteam[n].hp == 0){
        cout << "Status : " << myteam[n].namepokemon << " is dead" << endl;
        player1_unit_dead(myteam[n].skill);
        cout << "-------------------------" << endl;
    }
    ...
    cout << "-------------------------\n";
    player1_unit_stand(myteam[0].skill);
...
void player::showstat(int n, int who){
    if(who == 1){
        player1_unit_stand(myteam[n].skill);
        cout << "---------------------------------------------------------------------------------" << endl;
		...
		cout << "\t\t\t\t\tSKILL : "  << myteam[n].skillinfo << endl;
        cout << "\t\t\t\t\t---------------------------------------------------------------------------------" << endl;
        player2_unit_stand(myteam[n].skill);
    }
}
...
void drawscene(int p1, player &p_1, int p2, player &p_2){
    ...
    if(p2 == 1){
        ...
        if(!dodge1){
            player2_unit_attack(p_2.myteam[0].skill);
            double damage = p_2.takeNormalATK(0, p_1, winelement2);
            cout << "\t\t\t\t\t" << setw(2) << damage << " Damage";
        }
        else{
            player2_unit_stand(p_2.myteam[0].skill);
            cout << "\t\t\t\t\t" << "Miss!!!!!";
        }
    }
    if(p2 == 2){
        cout << "\t\t\t\t\tPlayer 2 Strike!!!!!" << endl;
        if(!dodge1){
            if(p1 != 4){
                player2_unit_attack(p_2.myteam[0].skill);
    ...
    if(p2 == 3){
        ...
        if(p1 != 2){
            p_2.def(0);
            checkdef2 = true;
            player2_unit_defend(p_2.myteam[0].skill);
        }
    }
    if(p2 == 4){
        cout << "\t\t\t\t\tPlayer 2 Counter!!!!!" << endl;
        if(p1 == 2){
            player2_unit_attack(p_2.myteam[0].skill);
    ...
    if(p1 == 1){
        ...
        if(!dodge2){
            player1_unit_attack(p_1.myteam[0].skill);
            double damage = p_1.takeNormalATK(0, p_2, winelement1);
            cout << " " << setw(2) << damage << " Damage";
        }
        else{
            player1_unit_stand(p_1.myteam[0].skill);
            cout << " " << "Miss!!!!!";
        }
    }
    if(p1 == 2){
        cout << "Player 1 Strike!!!!!" << endl;
        if(!dodge2){
            if(p2 != 4){
                player1_unit_attack(p_1.myteam[0].skill);
    ...
    if(p1 == 3){
        ...
        if(p2 != 2){
            p_1.def(0);
            checkdef1 = true;
            player1_unit_defend(p_1.myteam[0].skill);
        }
    }
    if(p1 == 4){
        cout << "Player 1 Counter!!!!!" << endl;
        if(p2 == 2){
            double damage = p_1.takeStrike(0, p_2, winelement1);
            player1_unit_attack(p_1.myteam[0].skill);
            cout << " " << setw(2) << damage << " Damage";
